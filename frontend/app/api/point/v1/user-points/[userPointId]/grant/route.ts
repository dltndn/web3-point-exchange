...
import { GrantReqDto, GrantHistoryResDto } from './dto';
...
export async function POST(
  ...
  try {
    ...
    const body: GrantReqDto = await request.json();
    ...
    // 실제 백엔드 API 호출
    const endpoint = `${API_CONFIG.ENDPOINTS.USER_POINTS}/${userPointId}/grant`;
